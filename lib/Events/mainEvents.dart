...
import 'Utility/StackedPics.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              title: Text('This super league Lorem 2017',style: TextStyle(color: darkRed)),
              subtitle: Text('Thu Oct 19, 2021 at 3:00pm',style: TextStyle(color: Colors.grey[400])),
              trailing: Text(
                'admin',
